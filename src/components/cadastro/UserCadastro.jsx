...
import top from '../../assets/img/de-volta-ao-topo.png'
...
export const Usercadastro = () => {
  ...
  return (
      <nav className='cadastro'>
        ...
        <img className='img-celular-2' src={celular} alt=""  id='cadastro' />
        ...
        <div className="quadrado1" >
          <div className='div-verde'>
            <a  onClick={goTop}  className='UserCadastro-voltar'><img style={{width: "76px"}} src={top} alt="" /></a>
            </div>
        </div>
      </nav>
  )
