...
import logo_carataoearthPreto from '../../../assets/img/cartai-listra-1.png'
import logo_carataoearth from '../../../assets/img/cartai-listra.png'
...
export const PagamentosDigitais = () => {
    return(
        <div className='PagamentosDigitais-div'>
            ...
            <div className='PagamentosDigitais-caixa-tudo'>
